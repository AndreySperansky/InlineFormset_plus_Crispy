...
class CollectionDetailView(DetailView):
    model = Collection
    template_name = 'employee/collection_detail.html'
...
class CollectionCreate(CreateView):
    model = Collection
    template_name = 'employee/collection_create.html'
    ...
    def get_success_url(self):
        return reverse_lazy('employee:collection_detail', kwargs={'pk': self.object.pk})
...
class CollectionDelete(DeleteView):
    ...
    success_url = reverse_lazy('employee:homepage')